...
left join {{ ref('claims_agg') }} c   on a.admission_id = c.admission_id
left join {{ ref('pharmacy_agg') }} p  on a.admission_id = p.admission_id
left join {{ ref('labs_latest') }} l   on a.admission_id = l.admission_id
;
